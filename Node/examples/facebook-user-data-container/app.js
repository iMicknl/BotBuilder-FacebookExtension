...
bot.dialog('/', [
    (session, args, next) => {
        ...
        let facebookData = session.userData['facebook_data'];
        session.send(`Hi ${facebookData.first_name}! You are a ${facebookData.gender} and you speak ${facebookData.locale}.`);
    }
]);